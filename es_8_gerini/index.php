  ...
  <div class="container mt-5">
    ...
    <form action="submit.php" method="get">
      ...
      <div class="mb-3">
        ...
        <div class="form-check">
          <input class="form-check-input" type="radio" id="parcheggio_custodito" name="parking" value="custodito" required>
          <label class="form-check-label" for="parcheggio_custodito">Parcheggio custodito</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" id="parcheggio_non_custodito" name="parking" value="non_custodito">
